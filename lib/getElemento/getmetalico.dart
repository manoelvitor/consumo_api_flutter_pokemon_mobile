...
class GetMetalico extends StatelessWidget {
  @override
...
class MyGetMetalico extends StatefulWidget {
  const MyGetMetalico({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MyGetMetalico> {
  List data = [];
  var getId;

  Future _atualizar() async {
    var url = Uri.parse('https://api-pokemon-fatec.herokuapp.com/pokemons/elemento/Metálico');
