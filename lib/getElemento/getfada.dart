...
class GetFada extends StatelessWidget {
  @override
...
class MyGetFada extends StatefulWidget {
  const MyGetFada({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MyGetFada> {
  List data = [];
  var getId;

  Future _atualizar() async {
    var url = Uri.parse('https://api-pokemon-fatec.herokuapp.com/pokemons/elemento/Fada');
