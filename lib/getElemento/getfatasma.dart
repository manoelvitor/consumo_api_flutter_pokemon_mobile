...
class GetFantasma extends StatelessWidget {
  @override
...
class MyGetFantasma extends StatefulWidget {
  const MyGetFantasma({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MyGetFantasma> {
  List data = [];
  var getId;

  Future _atualizar() async {
    var url = Uri.parse('https://api-pokemon-fatec.herokuapp.com/pokemons/elemento/Fantasma');
