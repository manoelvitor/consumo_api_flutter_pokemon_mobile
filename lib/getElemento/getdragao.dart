...
class GetDragao extends StatelessWidget {
  @override
...
class MyGetDragao extends StatefulWidget {
  const MyGetDragao({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MyGetDragao> {
  List data = [];
  var getId;

  Future _atualizar() async {
    var url = Uri.parse('https://api-pokemon-fatec.herokuapp.com/pokemons/elemento/Dragão');
