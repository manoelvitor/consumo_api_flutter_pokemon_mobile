...
class GetRocha extends StatelessWidget {
  @override
...
class MyGetRocha extends StatefulWidget {
  const MyGetRocha({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MyGetRocha> {
  List data = [];
  var getId;

  Future _atualizar() async {
    var url = Uri.parse('https://api-pokemon-fatec.herokuapp.com/pokemons/elemento/Rocha');
