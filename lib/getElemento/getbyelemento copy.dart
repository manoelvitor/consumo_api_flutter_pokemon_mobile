...
class GetEletrico extends StatelessWidget {
  @override
...
class MyGetEletrico extends StatefulWidget {
  const MyGetEletrico({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MyGetEletrico> {
  List data = [];
  var getId;

  Future _atualizar() async {
    var url = Uri.parse('https://api-pokemon-fatec.herokuapp.com/pokemons/elemento/Elétrico');
