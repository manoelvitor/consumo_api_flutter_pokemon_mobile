...
class GetNoturno extends StatelessWidget {
  @override
...
class MyGetNoturno extends StatefulWidget {
  const MyGetNoturno({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MyGetNoturno> {
  List data = [];
  var getId;

  Future _atualizar() async {
    var url = Uri.parse('https://api-pokemon-fatec.herokuapp.com/pokemons/elemento/Noturno');
