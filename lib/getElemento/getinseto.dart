...
class GetInseto extends StatelessWidget {
  @override
...
class MyGetInseto extends StatefulWidget {
  const MyGetInseto({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MyGetInseto> {
  List data = [];
  var getId;

  Future _atualizar() async {
    var url = Uri.parse('https://api-pokemon-fatec.herokuapp.com/pokemons/elemento/Inseto');
