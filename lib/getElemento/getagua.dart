...
class GetAgua extends StatelessWidget {
  @override
...
class MyGetAgua extends StatefulWidget {
  const MyGetAgua({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MyGetAgua> {
  List data = [];
  var getId;

  Future _atualizar() async {
    var url = Uri.parse('https://api-pokemon-fatec.herokuapp.com/pokemons/elemento/Agua');
