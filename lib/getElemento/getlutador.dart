...
class GetLutador extends StatelessWidget {
  @override
...
class MyGetLutador extends StatefulWidget {
  const MyGetLutador({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MyGetLutador> {
  List data = [];
  var getId;

  Future _atualizar() async {
    var url = Uri.parse('https://api-pokemon-fatec.herokuapp.com/pokemons/elemento/Lutador');
